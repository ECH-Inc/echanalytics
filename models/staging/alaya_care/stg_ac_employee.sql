...
flatten_cols AS(
    SELECT guid,
        ...
        profile:reason_for_restricted_duties::VARCHAR AS reason_for_restricted_duties,
        profile:employee_work_restrictions_start_date::VARCHAR AS employee_work_restrictions_start_date,
        ...
        user_settings:employee_designation::VARCHAR AS employee_designation,
        user_settings:employee_seniority_rank::VARCHAR AS employee_seniority_rank,
        user_settings:staffing_employee_position_type_id::VARCHAR AS staffing_employee_position_type_id,
        user_settings:staffing_payroll_number::VARCHAR AS staffing_payroll_number,
        user_settings:staffing_employee_position_type::VARCHAR AS staffing_employee_position_type,
        password_updated_at,
        created_at,
        created_by,
        updated_at,
