...
flatten_client AS(
    SELECT client_id AS ac_client_id,
        ...
        profile:carer_contact_name_primary_only::VARCHAR AS carer_contact_name_primary_only,
        ...
        profile:client_custom_stmt_delivery::VARCHAR AS client_custom_stmt_delivery,
        ...
        profile:hcp_client_discharged_to_another_provider::VARCHAR AS hcp_client_discharged_to_another_provider,
        ...
        profile:centrelink_reference_number::VARCHAR AS centrelink_reference_number,
        ...
        profile:hcp_client_transfer_from_another_provider::VARCHAR AS hcp_client_transfer_from_another_provider,
